...
use AuthBundle\Model\Items;
use AuthBundle\Model\ItemsQuery;
...
class ItemsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'AuthBundle.Model.Map.ItemsTableMap';
     ...
     */
    const OM_CLASS = '\\AuthBundle\\Model\\Items';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'AuthBundle.Model.Items';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'ItemName', ),
        self::TYPE_CAMELNAME     => array('id', 'itemName', ),
        self::TYPE_COLNAME       => array(ItemsTableMap::COL_ID, ItemsTableMap::COL_ITEM_NAME, ),
        self::TYPE_FIELDNAME     => array('id', 'item_name', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'ItemName' => 1, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'itemName' => 1, ),
        self::TYPE_COLNAME       => array(ItemsTableMap::COL_ID => 0, ItemsTableMap::COL_ITEM_NAME => 1, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'item_name' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\AuthBundle\\Model\\Items');
        $this->setPackage('AuthBundle.Model');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addColumn('item_name', 'ItemName', 'VARCHAR', false, 300, null);
    } // initialize()
    ...
    {
        $this->addRelation('Posts', '\\AuthBundle\\Model\\Posts', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':itemid',
    1 => ':id',
  ),
), null, null, 'Postss', false);
    } // buildRelations()
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(ItemsTableMap::COL_ID);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \AuthBundle\Model\Items) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(ItemsTableMap::DATABASE_NAME);
            $criteria->add(ItemsTableMap::COL_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(ItemsTableMap::COL_ID) && $criteria->keyContainsValue(ItemsTableMap::COL_ID) ) {
