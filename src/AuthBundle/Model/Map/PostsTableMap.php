...
use AuthBundle\Model\Posts;
use AuthBundle\Model\PostsQuery;
...
class PostsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'AuthBundle.Model.Map.PostsTableMap';
     ...
     */
    const OM_CLASS = '\\AuthBundle\\Model\\Posts';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'AuthBundle.Model.Posts';
     ...
     */
    const COL_CONTENT = 'posts.content';

    /**
     * the column name for the describe field
     */
    const COL_DESCRIBE = 'posts.describe';

    /**
     * the column name for the image field
     */
    const COL_IMAGE = 'posts.image';

    /**
     * the column name for the date_create field
     */
    const COL_DATE_CREATE = 'posts.date_create';

    /**
     * the column name for the delete field
     */
    const COL_DELETE = 'posts.delete';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Itemid', 'Title', 'Content', 'Describe', 'Image', 'DateCreate', 'Delete', ),
        self::TYPE_CAMELNAME     => array('id', 'itemid', 'title', 'content', 'describe', 'image', 'dateCreate', 'delete', ),
        self::TYPE_COLNAME       => array(PostsTableMap::COL_ID, PostsTableMap::COL_ITEMID, PostsTableMap::COL_TITLE, PostsTableMap::COL_CONTENT, PostsTableMap::COL_DESCRIBE, PostsTableMap::COL_IMAGE, PostsTableMap::COL_DATE_CREATE, PostsTableMap::COL_DELETE, ),
        self::TYPE_FIELDNAME     => array('id', 'itemid', 'title', 'content', 'describe', 'image', 'date_create', 'delete', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Itemid' => 1, 'Title' => 2, 'Content' => 3, 'Describe' => 4, 'Image' => 5, 'DateCreate' => 6, 'Delete' => 7, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'itemid' => 1, 'title' => 2, 'content' => 3, 'describe' => 4, 'image' => 5, 'dateCreate' => 6, 'delete' => 7, ),
        self::TYPE_COLNAME       => array(PostsTableMap::COL_ID => 0, PostsTableMap::COL_ITEMID => 1, PostsTableMap::COL_TITLE => 2, PostsTableMap::COL_CONTENT => 3, PostsTableMap::COL_DESCRIBE => 4, PostsTableMap::COL_IMAGE => 5, PostsTableMap::COL_DATE_CREATE => 6, PostsTableMap::COL_DELETE => 7, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'itemid' => 1, 'title' => 2, 'content' => 3, 'describe' => 4, 'image' => 5, 'date_create' => 6, 'delete' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\AuthBundle\\Model\\Posts');
        $this->setPackage('AuthBundle.Model');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addForeignKey('itemid', 'Itemid', 'INTEGER', 'items', 'id', false, null, null);
        $this->addColumn('title', 'Title', 'VARCHAR', false, 500, null);
        $this->addColumn('content', 'Content', 'VARCHAR', false, 30000, null);
    ...
    {
        $this->addRelation('Items', '\\AuthBundle\\Model\\Items', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':itemid',
    1 => ':id',
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PostsTableMap::COL_ITEMID);
            $criteria->addSelectColumn(PostsTableMap::COL_TITLE);
            $criteria->addSelectColumn(PostsTableMap::COL_CONTENT);
            $criteria->addSelectColumn(PostsTableMap::COL_DESCRIBE);
            $criteria->addSelectColumn(PostsTableMap::COL_IMAGE);
            $criteria->addSelectColumn(PostsTableMap::COL_DATE_CREATE);
            $criteria->addSelectColumn(PostsTableMap::COL_DELETE);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \AuthBundle\Model\Posts) { // it's a model object
