...
class AdminTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'AuthBundle.Model.Map.AdminTableMap';
     ...
     */
    const OM_CLASS = '\\AuthBundle\\Model\\Admin';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'AuthBundle.Model.Admin';
     ...
     */
    const COL_ACCOUNT = 'admin.account';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Account', 'Password', ),
        self::TYPE_CAMELNAME     => array('id', 'account', 'password', ),
        self::TYPE_COLNAME       => array(AdminTableMap::COL_ID, AdminTableMap::COL_ACCOUNT, AdminTableMap::COL_PASSWORD, ),
        self::TYPE_FIELDNAME     => array('id', 'account', 'password', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Account' => 1, 'Password' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'account' => 1, 'password' => 2, ),
        self::TYPE_COLNAME       => array(AdminTableMap::COL_ID => 0, AdminTableMap::COL_ACCOUNT => 1, AdminTableMap::COL_PASSWORD => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'account' => 1, 'password' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\AuthBundle\\Model\\Admin');
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(AdminTableMap::COL_ACCOUNT);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \AuthBundle\Model\Admin) { // it's a model object
