...
abstract class Admin implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\AuthBundle\\Model\\Map\\AdminTableMap';
    ...
    /**
     * Initializes internal state of AuthBundle\Model\Base\Admin object.
     */
     ...
     * @return $this|\AuthBundle\Model\Admin The current object (for fluent API support)
     */
    ...
    public function setAccount($v)
    {
        ...
        if ($this->account !== $v) {
            $this->account = $v;
            $this->modifiedColumns[AdminTableMap::COL_ACCOUNT] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AdminTableMap::translateFieldName('Account', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\AuthBundle\\Model\\Admin'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AdminTableMap::COL_ACCOUNT)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\AuthBundle\Model\Admin
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\AuthBundle\Model\Admin The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AdminTableMap::COL_ACCOUNT)) {
            $criteria->add(AdminTableMap::COL_ACCOUNT, $this->account);
        }
        if ($this->isColumnModified(AdminTableMap::COL_PASSWORD)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \AuthBundle\Model\Admin (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \AuthBundle\Model\Admin Clone of current object.
     * @throws PropelException
     */
