...
use \Exception;
use \PDO;
use AuthBundle\Model\Admin as ChildAdmin;
use AuthBundle\Model\AdminQuery as ChildAdminQuery;
use AuthBundle\Model\Map\AdminTableMap;
 ...
 * @method     ChildAdminQuery orderByAccount($order = Criteria::ASC) Order by the account column
 ...
 * @method     ChildAdminQuery groupByAccount() Group by the account column
 ...
 * @method     ChildAdmin findOneByAccount(string $account) Return the first ChildAdmin filtered by the account column
 ...
 * @method     ChildAdmin requireOneByAccount(string $account) Return the first ChildAdmin filtered by the account column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildAdmin[]|ObjectCollection findByAccount(string $account) Return ChildAdmin objects filtered by the account column
...
abstract class AdminQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \AuthBundle\Model\Base\AdminQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'test', $modelName = '\\AuthBundle\\Model\\Admin', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `id`, `account`, `password` FROM `admin` WHERE `id` = :p0';
        try {
    ...
    public function filterByAccount($account = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(AdminTableMap::COL_ACCOUNT, $account, $comparison);
    }
